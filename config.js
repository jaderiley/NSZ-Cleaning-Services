...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "NSZ Cleaning Services",
    phone:     "+27 65 889 8712",
    whatsapp:  "+27 65 889 8712",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "NSZ Cleaning Services — Services in krugersdorp",
    description: "NSZ Cleaning Services provides professional services in Krugersdorp. 2 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Services · Krugersdorp & surrounds",
    heroTitle:  "Professional service — <em>done right.</em>",
    heroLead:   "NSZ Cleaning Services provides professional services for homes and businesses across Krugersdorp and the surrounding area. Reliable, experienced and locally based.",
    ...
    band: {
      ...
      alt:   "NSZ Cleaning Services team at work in Krugersdorp",
      text:  "Professional service — reliable, experienced and locally based."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Krugersdorp. Serving the wider area.",
    areasLead:  "We work across Krugersdorp, Johannesburg, Randburg and surrounding suburbs for residential and commercial clients.",
    ...
    // ─── REVIEWS ───────────────────────────────────────────
    reviewsTitle: "From 2 verified Google reviews.",
    reviews: [
      {
